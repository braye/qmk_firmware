 ...
 * `-----------------------------------------/       /      \      \-----------------------------------------'
 *            | LGUI | LAlt | RAISE|Space | /Bkspc  /        \Del   \  |Enter | LOWER| RAlt | RGUI |
 *            |      |      |      |      |/       /          \      \ |      |      |      |      |
 *            `-----------------------------------'            '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT_via(
  ...
  KC_TAB,   KC_Q,   KC_W,    KC_E,      KC_R,    KC_T,    KC_VOLU,     KC_PGUP,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSLS,
  KC_LCTRL, KC_A,   KC_S,    KC_D,      KC_F,    KC_G,    KC_MUTE,     KC_NO,     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,      KC_V,    KC_B,    KC_VOLD,     KC_PGDN,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_EQL,
            KC_LGUI,KC_LALT, MO(_LOWER),KC_SPC, KC_BSPC,                          KC_DEL,  KC_ENT, MO(_RAISE), KC_LBRC, KC_RBRC
),
/*
 * COLEMAK - Vanilla
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT_via(
  ...
  _______, _______, KC_UP  , _______, _______, _______, _______,       _______, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_F12 ,
  KC_CAPS, KC_LEFT, KC_DOWN , KC_RIGHT, _______ , _______, _______,       _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
